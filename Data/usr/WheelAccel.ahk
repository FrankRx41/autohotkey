; 
; 		WheelAccel.ahk  (2009/06/20)
; 		by IKKI  http://www18.big.or.jp/~fujiwara/ikki/
; 
; WheelScroll.ahk の改造版。ホイール加速を滑らかにした。
; AutoHotkey 1.0.48.00 で動作確認済み。
; 
; ◆改造元
; WheelScroll.ahk  2008/05/25 (AutoHotkey 1.0.47.06)  by eamat
; http://lukewarm.s101.xrea.com/up/ の 085.zip
; 
; ◆以下オリジナルのコメント
;---------------------------------------------------------------------------
...
;   AcclSpeed         = 1           ;加速時の倍率(0で加速OFF)  ◆改造版では不使用
;   AcclTOut          = 300         ;加速タイムアウト値(ms)    ◆改造版では不使用
